...
function Box() {
  ...
  useEffect(() => {
    ...
    if (localStorage.getItem("draft")) {
      ...
      //Prepopulating the real store
    
  }, [realStore, , myDraft]); //infinite loop
            ...
            return (
              <div key={i}>
                <div className="box">
                  ...
                  >
                    ...
                    >
                      <div className="addcontainer">
                        ...
                        >
                          <Input
                            style={{ width: "22rem", marginLeft: "2.2rem" }}
                          />
                        </Form.Item>
                  ...
                  <button onClick={() => handleDelete(i, "realStore")}>
                    Delete
                  </button>
                </div>
              </div>
            ...
            return (
              <div key={i}>
                <div className="box">
                  ...
                  <p>{e.description}</p>
                  <button onClick={() => openAdd(i, "draft")}>Edit</button>
                  <button onClick={() => handleDelete(i, "draft")}>
                    Delete
                  </button>
                </div>
              </div>
